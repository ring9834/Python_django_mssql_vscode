...
INSTALLED_APPS = [
    ...
    'hello.apps.HelloConfig', # makes sure the project knows about the app so it can handle templating
    'hzx.apps.HzxConfig', # now Django knows to include the hzx app
]
